...
import { SliderVertivalChildComponent } from './layout-slider-vertical-child/layout-slider-vertical-child.component';
...
@Component({
  selector: 'layout-slider-vertical',
  templateUrl: 'layout-slider-vertical.component.html',
  styleUrls: ['layout-slider-vertical.component.scss']
})

export class SliderVerticalComponent implements AfterViewInit, OnInit, AfterContentInit {
