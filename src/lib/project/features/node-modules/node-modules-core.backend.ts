...
export class NodeModulesCore extends BaseFeatureForProject<Project> {
  ...
  public dedupe = (packagesOrOptions?: string[] | { packages?: string[]; reason: string }) => {
    ...
    const arrAddTrusted = tnpProj.__packageJson.data.tnp.core.dependencies['additionalTrusted'] || {};
  ...
  public dedupeCount = (packages?: string[]) => {
    dedupePackages(this.project.location, packages, true, !this.project.__npmPackages.useSmartInstall)
  };
