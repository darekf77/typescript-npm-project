...
if(typeof defineInjectable === 'function') {
/** @nocollapse */ FormlyConfig.ngInjectableDef =  defineInjectable({
...
class FieldExpressionExtension {
    ...
    postPopulate(field) {
        ...
        if (field.hideExpression) {
            ...
            field.hideExpression = this._evalExpression('hide', field.hideExpression, parent && parent.hideExpression ? (/**
             * @return {?}
             */
